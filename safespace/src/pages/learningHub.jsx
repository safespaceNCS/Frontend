...
<div className="pb-4 font-semibold text-2xl px-2 flex flex-row justify-between items-center"><span>{x.type}</span>
 {x.type ==="Game" ?(<a href="https://cyberhero-7sdw.onrender.com/" className="p-2 text-white rounded-xl bg-[#20B486]"><MdOutlineArrowOutward/></a>):(<button onClick={()=>setOpen(true)} className="p-2 text-white rounded-xl bg-[#20B486]"><MdOutlineArrowOutward/></button >)} </div>        
